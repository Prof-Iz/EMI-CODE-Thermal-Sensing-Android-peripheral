...
import 'package:thermaldisplay/qrSubmit.dart';
...
void main() {
  runApp(MaterialApp(theme: ThemeData(fontFamily: "Roboto"),debugShowCheckedModeBanner: false,home: HomeScreen()));
}
            ...
            children: [
              Visibility(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () =>
                      Navigator.push(context, new MaterialPageRoute(builder: (context) => QRSubmitPage(serialData))),
